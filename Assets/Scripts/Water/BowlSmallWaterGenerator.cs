...
public class BowlSmallWaterGenerator : MonoBehaviour
{
    ...
    [SerializeField] private BowlSmallWaterController _bowlSmallWaterController; // ボウルの水管理スクリプト
    [SerializeField] private MeshRenderer _waterSurfaceMeshRenderer;  // 水面のMeshRenderer
    [SerializeField] private BowlSmallWaterSurfaceGenerator _bowlSmallWaterSurfaceGenerator;
    ...
    void Start()
    {
        ...
        pouredWaterLevel = _bowlSmallWaterSurfaceGenerator.pouredWaterLevel;
    }
    ...
    private void ControllBowlWater()
    {
        ...
        if (pouredWaterLevel > 0)
        {
            if (tiltAngle >= tiltThreshold)
            {
                ...
                _bowlSmallWaterSurfaceGenerator.pouredWaterLevel--;
