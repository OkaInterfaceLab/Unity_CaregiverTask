...
public class BowlWaterSurfaceGenerator : MonoBehaviour
{
    [SerializeField] private BowlWaterController _bowlWaterController;
    ...
    private void Start()
    {
        ...
        // MeshRenderer を取得
        _meshRenderer = _bowlWaterController.GetComponent<MeshRenderer>();
    ...
    private void UpdateFillingRateFromPouredWaterLevel()
    {
        ...
        _bowlWaterController.fillingRate = fillingRate;
